...
<div class="product-list-section clearfix">
                <div class="cs-container content-container">
					...
					<div class="container-fluid overRideleft">
						...
						<c:forEach var="category" items="${categoryGridModel.categories}"
							varStatus="loopcnt">
							<c:set var="categoryObj" value="${category}" scope="request" />
							<cq:include path="categorypar-${loopcnt.index}"
								resourceType="hdscorp/components/content/categorygrid/categorytile" />
