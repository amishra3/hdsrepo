    		...
    		<div class="hero-container general">
    			...
    			<ul class="general-list col-sm-10 col-md-9 col-lg-8 clearfix">
    				<c:forEach var="tabList" items="${tabList}">
						...
						<li class="col-sm-6">
    						<a href="#" data-href="${tabOverlayPath}.overlay.html" class="general-healthcare"><span class="sprite icon-suitcase-red" style="background-image: url(${tabIconPath});background-position: 0 0"></span> ${tabTitle}</a>
