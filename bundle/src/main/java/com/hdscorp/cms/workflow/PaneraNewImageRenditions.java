...
@Service
@Properties({
		@Property(name = Constants.SERVICE_DESCRIPTION, value = "PaneraNewImageRenditions"),
		@Property(name = Constants.SERVICE_VENDOR, value = "Adobe"),
		@Property(name = "process.label", value = "Panera New Image Renditions") })
public class PaneraNewImageRenditions extends AbstractAssetWorkflowProcess
	...
	private static final Logger log = LoggerFactory
			.getLogger(PaneraNewImageRenditions.class);
